...
# MAGIC - Apply business logic to compute required fields.
# MAGIC - Derive SiteID from Site mapping.
# MAGIC
# MAGIC ---
# MAGIC
...
try:
    df_omni_desc.write.format("delta").mode("overwrite").save("s3://tfsdl-corp-fdt/test/psg/ctd/cert/omni_desc")
except Exception as e:
